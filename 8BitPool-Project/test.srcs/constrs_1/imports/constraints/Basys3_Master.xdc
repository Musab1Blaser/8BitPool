...
#set_property PACKAGE_PIN T1 [get_ports {switchNext}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {switchNext}]
...
#set_property PACKAGE_PIN W18 [get_ports {coll1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {coll1}]
#set_property PACKAGE_PIN U15 [get_ports {coll2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {coll2}]
#set_property PACKAGE_PIN U14 [get_ports {coll3}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {coll3}]
#set_property PACKAGE_PIN V14 [get_ports {mov}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {mov}]
